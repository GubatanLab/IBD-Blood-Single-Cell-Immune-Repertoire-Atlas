...
| S2 | A: participant-level diversity; B: CDR3-based clone-size composition; C: cell-state composition of exact paired alpha-beta clones; D: independent motif context | `analysis/figures/redraw_s2_s4_cell_press.py`, `compact_s2_single_page_20260920.py`; original motif-context workflow |
...
## Current figure assembly

The reviewed 20 September PDF files and manuscript-derived legends are authoritative for this snapshot. See `docs/paper-update-2026-09-20.md` for the supplementary-layout and final-review workflow order. Historical analysis scripts remain available but do not imply that every former supplementary panel is still shown.
